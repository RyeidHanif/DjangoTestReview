...
class TestAppointment:
    ...
    def test_appointment_str(self):
        ...
        assert (
            str(appointment)
            == f"Appointment by {appointment.customer.username} for {appointment.provider.username} on {appointment.date_start}"
        )
